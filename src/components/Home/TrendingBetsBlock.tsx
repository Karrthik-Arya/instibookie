...
const TrendingBetsBlock: FC = () => (
	<div className="block  shadow-lg shadow-emerald-700/50 mb-20 border-emerald-700/10 border-t rounded-lg  bg-gray-900 w-full py-3 px-4">
...
export default TrendingBetsBlock;